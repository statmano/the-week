...
The PWA registers a service worker and requests Notification permission. On Sundays the app will prompt you to add goals for the week and will try to show a notification.
